package com.ust.day4.ecommerce.notification.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderStatusEvent> orderStatusKafkaListenerContainerFactory() {
    ...
    private ConsumerFactory<String, OrderStatusEvent> orderStatusConsumerFactory() {
